...
If you are interested, please contact me through discord
      ...
      <v-row justify="center" class="main-banner-area rounded-xl pa-4">
        ...
        <v-col cols="4">
          <v-card hover ripple style="height:100%" href="https://youtu.be/qAUYVDzmHRg" target="_blank">
        ...
        <v-col cols="4">
          <v-card hover ripple style="height:100%" href="https://youtu.be/SD5__9FBOmE" target="_blank">
      ...
      <v-row justify="center" class="main-banner-area rounded-xl pa-4 mb-4">
        ...
        <v-col cols="4">
          <v-card hover ripple style="height:100%" href="https://youtu.be/qRZ0sOqywBo" target="_blank">
        ...
        <v-col cols="4">
          <v-card hover ripple style="height:100%" href="https://youtu.be/5tWcVF5yGhk" target="_blank">
      ...
      <v-row justify="center" class="main-banner-area rounded-xl pa-4">
        ...
        <v-col cols="4">
          <v-card hover ripple style="height:100%" href="https://youtu.be/CQ3phY2COL8" target="_blank">
        ...
        <v-col cols="4">
          <v-card hover ripple style="height:100%" href="https://youtu.be/hAsdJRbAUck" target="_blank">
      ...
      <v-row justify="center" class="main-banner-area rounded-xl pa-4 mb-4">
        ...
        <v-col cols="4">
          <v-card hover ripple style="height:100%" href="https://youtu.be/ZviFHGRWioY" target="_blank">
        ...
        <v-col cols="4">
          <v-card hover ripple style="height:100%" href="https://youtu.be/T8Weoliwvvo" target="_blank">
